...
import { AppBar, Button, CssBaseline, Toolbar, Box, Slide, useScrollTrigger } from '@mui/material';
...
export default function FixedBottomNavigation({ children }: FixedBottomNavigationProps) {
  ...
  const isProfile = location.pathname.startsWith('/profile') || location.pathname === '/';
