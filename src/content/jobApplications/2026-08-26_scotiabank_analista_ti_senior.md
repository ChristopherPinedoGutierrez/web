---
id: "2026-08-26_scotiabank_analista_ti_senior"
...
jobUrl: "https://jobs.scotiabank.com/job/Lima-Analista-Ti-Senior-LIM/605565117/"
technologies: ["ts","cleanArchitecture","react","nodejs","sdd","gemini","claude","promptEngineering","jira","mgtProj"]
linkedProjects: ["notificape","calculape"]
---

# [2026-08-26] Scotiabank Perú - Analista TI Senior

- **Empresa:** Scotiabank Perú
- **Rol Vacante:** Analista TI Senior (Desarrollo, Mantenimiento y Evolución de Aplicaciones Bancarias)
...
| :--- | :--- | :--- |
| **Área / Foco:** | Gestión de Continuidad, incidentes, proveedores, auditorías SBS/SUNAT y soporte. | **Ingeniería de Software pura:** Desarrollo con React/.NET/Java, pruebas, mantenimiento evolutivo y arquitectura. |
| **Tu Fit:** | 85% (Fuerte en arquitectura y gobernanza). | **95% (MATCH DIRECTO con tu stack: React, JavaScript, APIs, testing, Scrum).** |
| **Nivel:** | Rol consultivo / gobernanza técnica. | Rol de construcción activa de software a nivel senior. |
...
1. **Dominio del Stack Core:** React, JavaScript moderno, TypeScript, APIs y testing.
2. **Ciclo de Vida Completo:** Ingeniería de requerimientos (SDD), estimación precisa y trabajo con pruebas unitarias/integrales (UAT/IST).
3. **Calidad y Mantenibilidad:** Enfoque en código limpio, seguridad y buenas prácticas de desarrollo.
...
> **Input numérico exacto:** 8000 (o 7500)

### P2: ¿Cuál es tu experiencia con React, JavaScript y desarrollo de aplicaciones web?
> **Respuesta:** Cuento con amplia experiencia en el ecosistema React y JavaScript/TypeScript moderno, construyendo arquitecturas modulares, sistemas de diseño y aplicaciones web de alto rendimiento. Aplico metodologías ágiles y control de calidad riguroso en todo el ciclo de vida del desarrollo.
...
- **Mantenimiento Evolutivo:** Mejorar y agregar nuevas funcionalidades a sistemas bancarios existentes sin romper la compatibilidad.
...
1. **Herramientas de programación (Java / JS / React) y coordinación técnica:**
   - **Respuesta:** SÍ
   - *Detalle:* Dominio de programación estructurada y tipada, arquitecturas por capas y coordinación de iniciativas técnicas multidisciplinarias.
2. **Análisis y diseño de sistemas / Ingeniería de requerimientos / Modelamiento:**
   - **Respuesta:** SÍ
   - *Detalle:* Base central en Spec-Driven Development (SDD), diseño de contratos técnicos y modelado de flujos.
3. **Metodologías ágiles (Scrum, Kanban) y gestión de proyectos:**
   - **Respuesta:** SÍ
   - *Detalle:* Gestión de backlogs estructurados, estimación de hitos e iteraciones continuas.
4. **Gestión de riesgos, estimación de esfuerzos y servicios TI:**
   - **Respuesta:** SÍ
   - *Detalle:* Estimaciones basadas en especificación técnica, mitigación de riesgos de despliegue y control de cambios.
