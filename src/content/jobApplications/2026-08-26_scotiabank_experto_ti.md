---
id: "2026-08-26_scotiabank_experto_ti"
...
jobUrl: "https://jobs.scotiabank.com/job/Lima-EXPERTO-TI-LIM/605524017/"
technologies: ["ts","cleanArchitecture","sdd","gemini","claude","promptEngineering","cicd"]
linkedProjects: ["notificape","calculape"]
---

# [2026-08-26] Scotiabank Perú - Experto TI

- **Empresa:** Scotiabank Perú
- **Rol Vacante:** Experto TI (Technology Engineering - Continuidad y Disponibilidad)
...
1. **Ingeniería de Requerimientos y Spec-Driven Development (SDD):** Capacidad de traducir necesidades de negocio complejas en especificaciones técnicas claras y ejecutables (evitando retrabajos y estimando con precisión).
2. **Ciclo de Vida y Continuidad TI:** Enfoque en observabilidad, tipado estricto (TypeScript), pipelines automatizados y mitigación de fallos en producción.
3. **Gestión Técnica y Comunicación:** Experiencia interactuando con usuarios solicitantes, estimando costos/tiempos y asegurando cumplimiento de estándares.
...
> 
> **Respuesta lista para llamada:**
> *Mi compensación anterior correspondía a mi etapa formativa y universitaria. Desde mi egreso y durante mis últimos años me he desempeñado con total autonomía en el diseño de arquitecturas, ingeniería de requerimientos y liderazgo técnico de productos de software. Mis pretensiones de S/. 7,000 a S/. 8,000 están calibradas en base al alcance, responsabilidad técnica y valor que aporto para este rol de Experto TI.*
...
### P2: ¿Cuál es tu experiencia en análisis, diseño de sistemas e ingeniería de requerimientos?
> **Respuesta:** Cuento con sólida experiencia aplicando metodologías estructuradas (como Spec-Driven Development) para analizar y documentar requerimientos de negocio, modelar procesos y diseñar arquitecturas de software modulares. He liderado la conceptualización y especificación de soluciones end-to-end (NotificaPe, ecosistema SDD), asegurando contratos de datos claros, estimaciones realistas de esfuerzo y despliegues estables.

### P3: ¿Cómo abordas la gestión de incidentes y la continuidad del servicio en aplicaciones críticas?
> **Respuesta:** Priorizo la mitigación preventiva mediante arquitecturas desacopladas, tipado estricto y logs de diagnóstico estructurados. Ante incidentes en producción, aplico un enfoque sistemático de causa raíz (RCA) para restablecer la continuidad del servicio de inmediato e implementar correcciones definitivas documentadas bajo estándares de control de cambios.
...
- **Riesgo Operacional y Regulatorio (SBS / SUNAT):** Controles de seguridad, trazabilidad de código y auditoría exigidos por ley en el sector financiero.
- **Gestión de Proveedores / Terceros:** Supervisar que el software entregado por consultoras externas cumpla con los estándares arquitectónicos del banco.
