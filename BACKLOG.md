...
* **2026-09-23:** `[DATA]` **Avance en Proceso de Selección BBVA (Software Expert).** Notificación y convocatoria activa para el puesto de `Software Expert (JR00112698)` a través de la plataforma corporativa Genoma Work. Actualización del estado a `interview` (Entrevista / En Evaluación) y registro de la nueva fase en `src/content/jobApplications/2026-08-28_bbva_software_expert_sdd.md`. Compilación y recifrado AES-256-GCM en el Job Vault.
