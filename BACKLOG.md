...
* **2026-09-23:** `[DATA/CORE]` **Diversificación Estratégica de Postulaciones y Creación del Job Search Playbook.** Creación del manual operativo `JOB_SEARCH_PLAYBOOK.md` para prospección rápida en LinkedIn, Bumeran y Computrabajo abarcando Datos, BI, Automatización y TI. Ejecución del protocolo de 2 fases (Diagnóstico Go/No-Go y Ficha Enriquecida) con 5 nuevas postulaciones registradas y cifradas con AES-256-GCM en el Job Vault:
  1. *Experis Perú (Cliente Telecomunicaciones)* - `Ingeniero de Datos`: S/. 4,500 bruto mensual (SQL Server, MySQL, Power BI, Python y apoyo en iniciativas de IA).
  2. *Farmacias Peruanas (Inkafarma/Mifarma - Grupo Intercorp)* - `AI Engineer`: S/. 6,000 bruto mensual, 100% remoto (n8n, Make, agentes de IA, Prompt Engineering, RAG y TypeScript).
  3. *OSLO Logística (InRetail - Grupo Intercorp)* - `Analista de Datos Operativos`: S/. 4,500 bruto mensual (Apalancamiento de 2.5 años in-house para Arca Continental Lindley, Power BI, Excel avanzado/VBA y control de inventarios/despachos).
  4. *Stefanini Group (Perú)* - `Analista Funcional Junior`: S/. 4,500 bruto mensual (Scrum, Jira, levantamiento de requerimientos, historias de usuario, diagramas de procesos y SQL).
  5. *CSTI Corp* - `Analista de Datos Jr (Comercio Exterior)`: S/. 4,000 bruto mensual (SQL intermedio, Python con Pandas/ETL, Power BI y experiencia en logística Lindley).
  Evaluación y descarte estratégico fundamentado de 6 convocatorias por gaps técnicos específicos (Databricks, Apache Spark/Scala, ML tradicional bancario), licitaciones públicas con TDR rígido del Estado o conflicto de reclutador interno.
* **2026-09-23:** `[DATA]` **Culminación de Videoentrevista Asincrónica en BBVA (Software Expert).** Registro integral de la batería de 5 preguntas reales y speeches defendidos en la plataforma Appian / Genoma Work para el puesto de `Software Expert (JR00112698)`: trayectoria financiera, arquitectura agéntica en el SDLC (SDD), gobierno/seguridad/auditoría/FinOps de IA, cualidades y oportunidad de mejora, y valor agregado para el squad. Actualización del estado en `src/content/jobApplications/2026-08-28_bbva_software_expert_sdd.md`. Compilación y recifrado AES-256-GCM en el Job Vault.
* **2026-09-22:** `[DATA]` **Registro de Postulación AI Specialist en Banco de Crédito del Perú (BCP).** Creación de ficha enriquecida e inmutable en `src/content/jobApplications/2026-09-22_bcp_ai_specialist.md` (Vibe Coding, Agentes de IA, Copilotos, Gemini/Claude/ChatGPT, definición funcional y gobernanza SDD). Respuestas cuantitativas anti-filtro ATS y calibración salarial en S/. 5,000 bruto mensual (~S/. 4,000 netos bajo planilla de Régimen General BCP con 14 sueldos, utilidades bancarias récord y beneficios Credicorp). Compilación y cifrado automático AES-256-GCM en el Job Vault.
* **2026-09-22:** `[DATA]` **Registro de Postulación Desarrollador Frontend Semi Senior en MÉTRICA.** Creación de ficha enriquecida e inmutable en `src/content/jobApplications/2026-09-22_metrica_desarrollador_frontend_semisenior.md` (Vue 3 Composition API, TypeScript, HTML/CSS, Tailwind CSS, Material UI, APIs REST y despliegues S3/Kubernetes). Respuestas cuantitativas anti-filtro ATS y calibración salarial en S/. 5,000 bruto mensual (~S/. 4,000 netos bajo planilla de Régimen General con 14 sueldos y beneficios de ley). Compilación y cifrado automático AES-256-GCM en el Job Vault.
* **2026-09-22:** `[DATA]` **Registro de Postulación Full Stack Developer – Spec-Driven Development & AI.** Creación de ficha enriquecida e inmutable en `src/content/jobApplications/2026-09-22_consultoratech_fullstack_developer_sdd_ai.md` (Node.js, TypeScript, Angular, AWS Lambda, DynamoDB, PostgreSQL y marco de trabajo Spec-Driven Development con IA). Calibración cuantitativa anti-filtro ATS y pretensión salarial en S/. 5,000 bruto mensual (~S/. 4,000 netos bajo planilla de Régimen General, modalidad híbrida Miraflores). Compilación y cifrado automático AES-256-GCM en el Job Vault.
